...
enum ambit_commands_e {
    ...
    ambit_command_unkown3				= 0x0b1e, // Ambit3 Peak fw 2.0.4
    ambit_command_ambit3_memory_map     = 0x0b21,
    ambit_command_unkown4				= 0x0b25, // Ambit3 Peak fw 2.0.4
    ambit_command_unkown5				= 0x0b26, // Ambit3 Peak fw 2.0.4
    ambit_command_unkown6				= 0x0b27, // Ambit3 Peak fw 2.0.4
    ambit_command_ambit3_settings       = 0x1100,
    ambit_command_ambit3_settings_write = 0x1101,
    ambit_command_unkown7				= 0x1104, // Ambit3 Peak fw 2.0.4 (probably Read FW)
    ambit_command_ambit3_log_headers    = 0x1200,
    ambit_command_ambit3_log_synced     = 0x1201,
    ambit_command_unkown8				= 0x1202, // Ambit3 Peak fw 2.0.4
};
